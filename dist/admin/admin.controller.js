...
let AdminController = class AdminController {
    ...
    async updateMerchantFee(id, data) {
        return this.adminService.updateMerchantFee(id, data);
    }
    async updateMerchantStatus(id, data) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AdminController.prototype, "getMerchantDetails", null);
__decorate([
    (0, common_1.Put)('merchants/:id/fee'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, admin_dto_1.UpdateMerchantFeeDto]),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "updateMerchantFee", null);
__decorate([
    (0, common_1.Put)('merchants/:id/status'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, admin_dto_1.UpdateMerchantStatusDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [admin_dto_1.DateRangeDto]),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "getChargebacks", null);
